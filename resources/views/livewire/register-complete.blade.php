    ...
    <div class="container">
        ...
        <div class="content-box">
            ...
            <div class="complete-message">
                <p>ふるさと住民登録申請を受け付けました。</p>
                <p>ご登録いただいたメールアドレスに確認メールをお送りしましたので、ご確認ください。</p>
                <p>申請内容を確認後、ふるさと住民票カードを発行いたします。</p>
                <p>発行までに1〜2週間ほどお時間をいただきます。</p>
            </div>

            <div class="notice-box">
                <h2 class="notice-title">今後のお手続きについて</h2>
                <p>ふるさと住民票カードの発行が完了しましたら、ご登録いただいたメールアドレスにお知らせいたします。</p>
                <p>その後、ご登録いただいた住所に郵送にてお届けいたします。</p>
            </div>
